...
const navItems = [
  { path: '/', icon: 'search', filledIcon: 'search', label: 'Search', desktopLabel: 'Smart Search', desktopIcon: 'manage_search' },
  { path: '/dashboard', icon: 'grid_view', filledIcon: 'grid_view', label: 'Dash', desktopLabel: 'Dashboard', desktopIcon: 'dashboard' },
  ...
  { path: '/guide', icon: 'bolt', filledIcon: 'bolt', label: 'Guide', desktopLabel: 'Guide', desktopIcon: 'menu_book' },
];
