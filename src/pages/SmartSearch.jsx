                ...
                <div className="relative h-40 bg-surface-container overflow-hidden">
                  {item.image && !imgError ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center">
                                  <span className="material-symbols-outlined text-4xl text-on-surface-variant opacity-30">image</span>span>
                      </div>div>
                        )}
                ...
                <div className="p-4 flex flex-col flex-grow">
                  ...
                  {item.location && (
                      <p className="text-xs text-on-surface-variant flex items-center gap-1 mb-3">
                                  <span className="material-symbols-outlined text-sm">location_on</span>span>
                        {item.location}
                      </p>p>
                        )}
                ...
                <section className="relative px-4 sm:px-6 pt-10 pb-6 hero-gradient">
                        <div className="max-w-4xl mx-auto text-center">
                                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-semibold mb-5">
                                              <span className="material-symbols-outlined text-sm material-filled">auto_awesome</span>span>
                          ...
                          {/* Search bar */}
                                  <div className="relative max-w-2xl mx-auto mb-4">
                                              <div className="flex items-center gap-3 bg-surface-container border border-primary/30 focus-within:border-primary/60 rounded-2xl px-4 py-3 transition-all duration-200 glow-blue focus-within:shadow-[0_0_30px_rgba(97,205,255,0.2)]">
                                                            <span className="material-symbols-outlined text-primary text-xl flex-shrink-0">search</span>span>
                                                            <input
                                                                              ref={inputRef}
                                                                              type="text"
                                                                              value={query}
                            ...
                            <button
                                              ...
                                              >
                                              <span className="material-symbols-outlined text-lg">close</span>span>
                            </button>button>
                                                            )}
                                              </div>div>
                                  </div>div>
                          ...
                          {/* Action row */}
                                  <div className="flex items-center justify-center gap-3 mb-6 flex-wrap">
                                              ...
                                              <button
                                                            ...
                                                            >
                                                            <span className="material-symbols-outlined text-sm">tune</span>span>
                                                            Filters
                                              </button>button>
                                  </div>div>
                        ...
                        <div className="glass-card border border-outline-variant/10 rounded-2xl p-5 max-w-2xl mx-auto mb-6 text-left animate-slide-up">
                                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                                        {/* Category */}
                                                      <div>
                                                                        <label className="block text-xs text-on-surface-variant font-semibold mb-1.5 uppercase tracking-wider">Category</label>label>
                                                                        <select
                                                                                              value={category}
                                                                                            ...
                                                                                            >
                                                                          {CATEGORIES.map(c => <option key={c.value} value={c.value}>{c.label}</option>option>)}
                                                                        </select>select>
                                                      </div>div>
                                        {/* Location - free text input for worldwide support */}
                                                      <div>
                                                                        <label className="block text-xs text-on-surface-variant font-semibold mb-1.5 uppercase tracking-wider">Location</label>label>
                                                                        <input
                                                                                              type="text"
                                                                                              value={location}
                                        ...
                                        {/* Min Price */}
                                                      <div>
                                                                        <label className="block text-xs text-on-surface-variant font-semibold mb-1.5 uppercase tracking-wider">Min Price ($)</label>label>
                                                                        <input
                                                                                              type="number"
                                                                                              value={minPrice}
                                        ...
                                        {/* Max Price */}
                                                      <div>
                                                                        <label className="block text-xs text-on-surface-variant font-semibold mb-1.5 uppercase tracking-wider">Max Price ($)</label>label>
                                                                        <input
                                                                                              type="number"
                                                                                              value={maxPrice}
                          ...
                          {/* Site toggles */}
                                      <div>
                                                      <label className="block text-xs text-on-surface-variant font-semibold mb-2 uppercase tracking-wider">Sites to Search</label>label>
            ...
            {error && (
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 mb-4">
                              <div className="p-4 bg-red-500/10 border border-red-500/30 rounded-xl text-red-400 text-sm flex items-center gap-3">
                                          <span className="material-symbols-outlined">error</span>span>
                                {error}
            ...
            {loading && (
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
                              <div className="flex items-center gap-3 mb-6">
                                          ...
                                          <p className="text-on-surface-variant text-sm">Searching across multiple sites…</p>p>
                              </div>div>
                      ...
                      {/* Stats bar */}
                              <div className="flex flex-wrap items-center gap-3 mb-6">
                                          <div className="flex items-center gap-2">
                                                        <span className="font-headline font-bold text-lg text-on-surface">{results.totalResults}</span>span>
                                                        <span className="text-on-surface-variant text-sm">results</span>span>
                                          </div>div>
                                          <span className="text-outline-variant">•</span>span>
                                          <div className="flex flex-wrap gap-2">
                                            {results.sites.map(s => (
                                      <div
                                                          key={s.id}
                                                        ...
                                                        >
                                        {s.error ? (
                                                                              <span className="material-symbols-outlined text-xs">error</span>span>
                                                                            ) : (
                                                                              <span className="font-bold">{s.count}</span>span>
                                                        )}
                                        ...
                                        {s.url && (
                                                                              <a href={s.url} target="_blank" rel="noopener noreferrer" className="opacity-70 hover:opacity-100" onClick={e => e.stopPropagation()}>
                                                                                                    <span className="material-symbols-outlined text-xs">open_in_new</span>span>
                                                                              </a>a>
                                                        )}
                                      </div>div>
                                    ))}
                      ...
                      {results.totalResults === 0 ? (
                                  <div className="text-center py-16">
                                                <div className="w-20 h-20 rounded-full bg-surface-container flex items-center justify-center mx-auto mb-4">
                                                                <span className="material-symbols-outlined text-4xl text-on-surface-variant">search_off</span>span>
                                                </div>div>
                                                <h3 className="font-headline font-bold text-xl mb-2">No results found</h3>h3>
