              ...
              <section className="flex-1 flex flex-col items-center justify-center px-4 py-12 sm:py-20">
                ...
                {/* Search Bar */}
                      <form onSubmit={handleSearch} className="w-full max-w-2xl mb-6">
                                <div className="glass-card border border-outline-variant/20 rounded-2xl p-2 flex items-center gap-2">
                                            <span className="material-symbols-outlined text-primary text-2xl ml-3">search</span>span>
                                            <input
                                                            type="text"
                                                            value={query}
                ...
                {/* Location Selector - Free text with suggestions */}
                      <div className="relative mb-6" ref={locationRef}>
                                <button
                                            ...
                                            >
                                            <span className="material-symbols-outlined text-primary text-sm">location_on</span>span>
                                            <span className="font-label text-sm text-on-surface">{location}</span>span>
                                            <span className="material-symbols-outlined text-on-surface-variant text-sm">expand_more</span>span>
                                </button>button>
                      ...
                      <div className="absolute top-full mt-2 left-1/2 -translate-x-1/2 z-50 glass-panel border border-outline-variant/20 rounded-xl p-3 w-80 sm:w-96">
                        {/* Search input for location */}
                                    <div className="flex items-center gap-2 mb-2 px-2 py-1.5 bg-on-surface/5 rounded-lg">
                                                    <span className="material-symbols-outlined text-on-surface-variant text-sm">search</span>span>
                                                    <input
                                                                        type="text"
                                                                        value={locationInput}
                ...
                {/* Marketplace Toggles */}
                      ...
                      <button
                                    ...
                                    >
                                    <span className="text-base">{mp.icon}</span>span>
                        {mp.name}
                        {!mp.active && <span className="text-[10px] opacity-60">Soon</span>span>}
                      </button>button>
                    ))}
                      </div>div>
                ...
                {/* Popular Searches */}
                      <div className="text-center max-w-2xl">
                                <p className="font-label text-xs text-on-surface-variant/60 uppercase tracking-wider mb-3">Popular searches</p>p>
          ...
          {/* Stats Bar */}
              <footer className="border-t border-outline-variant/10 px-6 py-4">
                      <div className="max-w-4xl mx-auto flex justify-center gap-8 sm:gap-16 text-center">
                                <div>
                                            <div className="font-headline font-bold text-primary text-lg">5</div>div>
                                            <div className="font-label text-xs text-on-surface-variant">Marketplaces</div>div>
                                </div>div>
                                <div>
                                            <div className="font-headline font-bold text-primary text-lg">Worldwide</div>div>
                                            <div className="font-label text-xs text-on-surface-variant">Any City</div>div>
                                </div>div>
                                <div>
                                            <div className="font-headline font-bold text-primary text-lg">Real-time</div>div>
                                            <div className="font-label text-xs text-on-surface-variant">Live Results</div>div>
                                </div>div>
                      </div>div>
              </footer>footer>
        </div>div>
